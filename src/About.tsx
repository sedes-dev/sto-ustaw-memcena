  ...
  return (
    <div id="about" className="about">
      ...
      <p className="about__paragraph">
        Urodziłem się dawno temu w Toruniu, ukończyłem gimnazjum z czerwonym paskiem i tyle mi wystarczyło. Już od najmłodszych lat masakrowałem nauczycieli WOSu swoimi poglądami i pomysłami. Zaraz po opuszczeniu murów szkoły pod skrzydła wziął mnie najlepszy polski polityk, moralny spadkobierca Józefa Pisłudskiego, niestrudzony w walce o wolność i normalność, Szanowny Pan Janusz Kurwin-Mickey.
      </p>
      <p className="about__paragraph">
